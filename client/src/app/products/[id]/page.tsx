...
const MOCK_PRODUCT: Product = {
  ...
  category: 'Outerwear',
  description:
    'A timeless silhouette meticulously crafted from premium Italian wool blend. Featuring a tailored fit, notched lapels, and a subtle textured finish that elevates any ensemble from casual to formal.',
  images: {
    primary:
      ...
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col">
              ...
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star
                    ...
                    size={14}
                    fill={i < 4 ? 'black' : 'none'}
                    className={i < 4 ? 'text-black' : 'text-gray-300'}
                  />
                ))}
            ...
            <p className="text-gray-600 leading-relaxed mb-10 max-w-lg">{product.description}</p>
